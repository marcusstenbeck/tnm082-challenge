...
public class Group{
	...
	protected List<User> userListmissions;
	...
	public List<User> getUserByMission(int userid){
		userListmissions = db.getUsersFromCurrentGroupWhoHasAcceptedORCompletedThisMission(id, userid);
		return userListmissions;
	}
